...
def mk_makefile():
    ...
    for c in get_components():
        if c.main_component():
            out.write(' %s' % c.name)
    out.write('\n\t@echo partitioner was successfully built.\n')
    ...
    if VERBOSE:
        ...
        if IS_WINDOWS:
            if VS_X64:
                print("  platform: x64\n")
                print("To build partitioner, open a [Visual Studio x64 Command Prompt], then")
            elif VS_ARM:
                print("  platform: ARM\n")
                print("To build partitioner, open a [Visual Studio ARM Command Prompt], then")
            else:
                print("  platform: x86")
                print("To build partitioner, open a [Visual Studio Command Prompt], then")
            ...
            print("Type 'cd %s; make' to build partitioner" % BUILD_DIR)
